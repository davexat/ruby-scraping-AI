...
ax = sns.barplot(x='Percentage', y='Company', hue='Company', data=df_1)

plt.title('% de Titulares que mencionan empresas líderes', fontsize=16, fontweight='bold')
plt.xlabel('% de Titulares')
plt.ylabel('Empresa')

for container in ax.containers:
    tmp_hue = df_1.loc[df_1['Company']==container.get_label()]
